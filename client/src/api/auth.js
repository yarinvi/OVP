...
export const signUp = async (payload) => {
  try {
    ...
    const message =
      ...
      "an erro occurred while signing up. please try agian.";
...
export const signIn = async (payload) => {
  try {
    ...
    const message =
      error.response?.data.message ||
      "an erro occurred while signing in. please try agian.";
...
export const logOut = async () => {
  try {
    ...
    const message =
      error.response?.data.message ||
      "an erro occurred while loging out. please try agian.";
